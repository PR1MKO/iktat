...
def upgrade():
    ...
    op.create_table(
        'investigation_note',
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('investigation_id', sa.Integer(), sa.ForeignKey('investigation.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_index('ix_investigation_attachment_uploaded_by', 'investigation_attachment', ['uploaded_by'])
    ...
    op.create_index('ix_investigation_change_log_edited_by', 'investigation_change_log', ['edited_by'])


def downgrade():
    op.drop_index('ix_investigation_change_log_edited_by', table_name='investigation_change_log')
    op.drop_table('investigation_change_log')

    op.drop_index('ix_investigation_attachment_uploaded_by', table_name='investigation_attachment')
