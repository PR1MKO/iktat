...
def upgrade():
    with op.batch_alter_table('case', schema=None) as batch_op:
        batch_op.add_column(sa.Column('halalt_megallap_pathologus', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('halalt_megallap_kezeloorvos', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('halalt_megallap_mas_orvos', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('boncolas_tortent', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('varhato_tovabbi_vizsgalat', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('kozvetlen_halalok', sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column('kozvetlen_halalok_ido', sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column('alapbetegseg_szovodmenyei', sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column('alapbetegseg_szovodmenyei_ido', sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column('alapbetegseg', sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column('alapbetegseg_ido', sa.String(length=64), nullable=True))
